...
static constexpr uint8_t rcon[255] = {
...
template class AesProtocol<4u, 4u, 10u>;
template class AesProtocol<6u, 4u, 12u>;
template class AesProtocol<8u, 4u, 14u>;
