...
#include "Syscalls/ManyPrefixSumSyscall.h"
...
SHAREMIND_MODULE_API_0x1_INITIALIZER(c) {
    ...
    */
    try {
        c->moduleHandle = new sharemind::Shared3pModule(logger);
        return SHAREMIND_MODULE_API_0x1_OK;
    } catch (...) {
        return catchModuleApiErrors ();
    }
...
NAMED_SYSCALL_WRAPPER(vecmax_float32_vec, unary_arith_vec<s3p_float32_t, MinimumMaximumProtocol<Shared3pPDPI, ModeMax>>)
NAMED_SYSCALL_WRAPPER(vecmax_float64_vec, unary_arith_vec<s3p_float64_t, MinimumMaximumProtocol<Shared3pPDPI, ModeMax>>)
...
NAMED_SYSCALL_WRAPPER(mul_fix32_vec, binary_arith_vec<s3p_uint32_t, FixMultiplicationProtocol>)
NAMED_SYSCALL_WRAPPER(mul_fix64_vec, binary_arith_vec<s3p_uint64_t, FixMultiplicationProtocol>)
...
NAMED_SYSCALL_WRAPPER(inv_fix32_vec, unary_arith_vec<s3p_uint32_t, FixInverseProtocol>)
NAMED_SYSCALL_WRAPPER(inv_fix64_vec, unary_arith_vec<s3p_uint64_t, FixInverseProtocol>)
...
NAMED_SYSCALL_WRAPPER(exp_fix32_vec, unary_arith_vec<s3p_uint32_t, FixExponentProtocol>)
NAMED_SYSCALL_WRAPPER(exp_fix64_vec, unary_arith_vec<s3p_uint64_t, FixExponentProtocol>)
...
NAMED_SYSCALL_WRAPPER(ln_fix32_vec, unary_arith_vec<s3p_uint32_t, FixNaturalLogarithmProtocol>)
NAMED_SYSCALL_WRAPPER(ln_fix64_vec, unary_arith_vec<s3p_uint64_t, FixNaturalLogarithmProtocol>)
...
NAMED_SYSCALL_WRAPPER(sqrt_fix32_vec, unary_arith_vec<s3p_uint32_t, FixSquareRootProtocol>)
NAMED_SYSCALL_WRAPPER(sqrt_fix64_vec, unary_arith_vec<s3p_uint64_t, FixSquareRootProtocol>)
...
NAMED_SYSCALL_WRAPPER(mat_multx_xor_uint8_t, mat_mult<s3p_xor_uint8_t>)
...
NAMED_SYSCALL_WRAPPER(scatter_fix32_t, scatter<s3p_uint32_t>)
NAMED_SYSCALL_WRAPPER(scatter_fix64_t, scatter<s3p_uint64_t>)
...
NAMED_SYSCALL_WRAPPER(gather_fix32_t, gather<s3p_uint32_t>)
NAMED_SYSCALL_WRAPPER(gather_fix64_t, gather<s3p_uint64_t>)
...
NAMED_SYSCALL_WRAPPER(many_prefix_sum_uint8_vec, many_prefix_sum<s3p_uint8_t, true>)
NAMED_SYSCALL_WRAPPER(many_prefix_sum_uint16_vec, many_prefix_sum<s3p_uint16_t, true>)
NAMED_SYSCALL_WRAPPER(many_prefix_sum_uint32_vec, many_prefix_sum<s3p_uint32_t, true>)
NAMED_SYSCALL_WRAPPER(many_prefix_sum_uint64_vec, many_prefix_sum<s3p_uint64_t, true>)
NAMED_SYSCALL_WRAPPER(many_prefix_sum_xor_uint8_vec, many_prefix_sum<s3p_xor_uint8_t, true>)
NAMED_SYSCALL_WRAPPER(many_prefix_sum_xor_uint16_vec, many_prefix_sum<s3p_xor_uint16_t, true>)
NAMED_SYSCALL_WRAPPER(many_prefix_sum_xor_uint32_vec, many_prefix_sum<s3p_xor_uint32_t, true>)
NAMED_SYSCALL_WRAPPER(many_prefix_sum_xor_uint64_vec, many_prefix_sum<s3p_xor_uint64_t, true>)
NAMED_SYSCALL_WRAPPER(many_prefix_sum_int8_vec, many_prefix_sum<s3p_int8_t, true>)
...
SHAREMIND_MODULE_API_0x1_SYSCALL_DEFINITIONS(
 ...
 // Casting
  ...
  , NAMED_SYSCALL_DEFINITION("shared3p::assign_fix64_vec", assign_uint64_vec)
  ...
  , NAMED_SYSCALL_DEFINITION("shared3p::get_type_size_fix64", get_type_size_uint64)
  ...
  , NAMED_SYSCALL_DEFINITION("shared3p::mat_multx_xor_uint8_vec", mat_multx_xor_uint8_t)
  ...
  , NAMED_SYSCALL_DEFINITION("shared3p::many_prefix_sum_uint8_vec", many_prefix_sum_uint8_vec)
  , NAMED_SYSCALL_DEFINITION("shared3p::many_prefix_sum_uint16_vec", many_prefix_sum_uint16_vec)
  , NAMED_SYSCALL_DEFINITION("shared3p::many_prefix_sum_uint32_vec", many_prefix_sum_uint32_vec)
  , NAMED_SYSCALL_DEFINITION("shared3p::many_prefix_sum_uint64_vec", many_prefix_sum_uint64_vec)
  , NAMED_SYSCALL_DEFINITION("shared3p::many_prefix_sum_xor_uint8_vec", many_prefix_sum_xor_uint8_vec)
  , NAMED_SYSCALL_DEFINITION("shared3p::many_prefix_sum_xor_uint16_vec", many_prefix_sum_xor_uint16_vec)
  , NAMED_SYSCALL_DEFINITION("shared3p::many_prefix_sum_xor_uint32_vec", many_prefix_sum_xor_uint32_vec)
  , NAMED_SYSCALL_DEFINITION("shared3p::many_prefix_sum_xor_uint64_vec", many_prefix_sum_xor_uint64_vec)
  , NAMED_SYSCALL_DEFINITION("shared3p::many_prefix_sum_int8_vec", many_prefix_sum_int8_vec)
